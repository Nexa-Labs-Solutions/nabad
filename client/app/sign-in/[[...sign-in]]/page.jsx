      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center mb-6 w-full text-center">
          <div className="flex items-center justify-center gap-3">
             ...
             <span className="text-4xl font-black bg-gradient-to-r from-[#ffb3b3] via-[#ff5260] to-[#d4145a] bg-clip-text text-transparent transform translate-y-1 italic">
               {t.brand.name}
             </span>
          </div>
          <p className="text-[#e3bebd]/60 text-sm font-medium tracking-wide mt-2">{t.brand.lifeline}</p>
        </div>

        <div className="w-full flex justify-center flex-col items-center">
          <SignIn
            appearance={clerkAppearance}
            signUpUrl="/sign-up/donor"
