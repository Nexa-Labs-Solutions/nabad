    ...
    <div className="min-h-screen bg-[#080e1a] flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-[#ff5260]/10 border border-[#ff5260]/20">
            <span className="material-symbols-outlined text-[#ff5260]" style={{ fontVariationSettings: "'FILL' 1", fontSize: '14px' }}>
              volunteer_activism
            </span>
            <span className="text-xs font-bold text-[#ff5260] uppercase tracking-widest">Donor Account</span>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-[#e3bebd]/30 mt-6">
          Registering as a hospital?{' '}
          <a href="/sign-up/hospital" className="text-[#ff5260] hover:underline">Apply here</a>
        </p>
      </div>
    </div>
  )
